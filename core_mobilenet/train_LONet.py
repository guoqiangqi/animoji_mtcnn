...
base_dir = os.path.join(root_dir, '../data/training_data/L48_mobilenet18874/imglists/LONet')
model_path = os.path.join(root_dir, '../models/LONet_mobilenet18874/LONet')
logs_dir = os.path.join(root_dir, '../models/logs/LONet_mobilenet18874')
