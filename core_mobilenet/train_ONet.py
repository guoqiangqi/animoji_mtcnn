...
from mtcnn_model import O_Net,read_multi_tfrecords,train_model,random_flip_images

root_dir = os.path.dirname(os.path.realpath(__file__)) 
base_dir = os.path.join(root_dir, '../data/imglists/ONet')
model_path = os.path.join(root_dir, '../models/ONet/ONet')
logs_dir = os.path.join(root_dir, '../models/logs/ONet')
...
cls_loss_op,bbox_loss_op,landmark_loss_op,L2_loss_op,accuracy_op,recall_op = O_Net(input_image, label, bbox_target,landmark_target,training=True)
