...
def gen_nose_bbox_data(neg_file, pos_file, save_dir, debug=False):
    ...
    # wmin, wmax, hmin, hmax = 13, 698, 18, 1164
    ...
    for pos in pos_list:
        ...
        _x1, _y1, _x2, _y2 = nose_box[:4]

        w = _x2 - _x1 + 1
        h = _y2 - _y1 + 1


        box = np.asarray(nose_box)
...
if __name__ == '__main__':
    ...
    save_dir = './train_image/nose'
    if os.path.exists(save_dir):
        shutil.rmtree(save_dir)
    files = gen_nose_bbox_data(neg_list_file, pos_list_file, save_dir, debug=True)