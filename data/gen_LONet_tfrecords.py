...
if __name__ == '__main__': 
    ...
    save_dir = os.path.join(root_dir, 'L48_expand2')
    landmark_txt = os.path.join(root_dir, 'lfw/trainImageList.txt')
    animoji_txt = os.path.join(root_dir, '300w//ImageList.txt')
    # train_root = os.path.join(root_dir, '')
    tfrecords_output_dir = os.path.join(root_dir, 'imglists/LONet_expand2')
